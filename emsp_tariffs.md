...
| **price_round** | Object containing 2 properties: round_granularity (« UNIT », « TENTH », « HUNDREDTH », « THOUSANDTH »). round_rule (« ROUND_UP », « ROUND_DOWN », « ROUND_NEAR ») | 1 | Rounding of the price applied for each “TariffElement” after the calculation of “the energy delivered in the TariffElement” or “the time spent in the TariffElement”. |
